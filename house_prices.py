...
def main():
    ...
    size = st.number_input('Area in Square metres',value = 1000,step=1)
    beds = st.number_input('Number of Bedrooms',value=3,step=1)
    ...
    if st.button('Predict Price',):
        ...
        st.success(f'The price is ${int(prediction[0])}')
